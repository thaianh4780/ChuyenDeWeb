                                ...
                                <ul class="navbar-nav flex-nowrap ms-auto">
                                    ...
                                    <li class="nav-item dropdown no-arrow mx-1">
                                        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">7</span><i class="fas fa-envelope fa-fw"></i></a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                                <h6 class="dropdown-header">alerts center</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="assets1/img/avatars/avatar4.jpeg" />
                                                    ...
                                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="assets1/img/avatars/avatar2.jpeg" />
                                                    ...
                                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="assets1/img/avatars/avatar3.jpeg" />
                                                    ...
                                                    <div class="dropdown-list-image me-3"><img class="rounded-circle" src="assets1/img/avatars/avatar5.jpeg" />
                                                        <div class="bg-success status-indicator"></div>
                                                    </div>
                                                    <div class="fw-bold">
                                    ...
                                    <li class="nav-item dropdown no-arrow">
                                        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="assets1/img/avatars/avatar1.jpeg"/></a>
                                    ...
                                    <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                        <table class="table my-0" id="dataTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img class="rounded-circle me-2" width="30" height="30" src="assets1/img/avatars/avatar2.jpeg" />Bruno Nash<br /></td>
                                                    <td>Software Engineer</td>
                                                    <td>London</td>
                                                    <td>38</td>
                                                    <td>2011/05/03<br /></td>
